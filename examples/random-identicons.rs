...
fn main() {
    let mut pk: [u8; 32] = [
        ...
        198, 174, 163, 126, 121,
        255, 255, 255,
        227, 69, 62, 220, 152, 128, 102
    ]; 
    
    /*    let pk: [u8; 32] = [
        190, 94, 7, 2, 219, 8, 181, 85, 72, 201, 209, 0, 113, 106, 161, 39, 4,
        198, 174, 163, 126, 121, 3, 218, 126, 227, 69, 62, 220, 152, 128, 102
    ];*/
    ...
    //drop(image::ImageRgb8(img).save(outfile, image::PNG));
    //drop(image::ImageLuma8(img).save(outfile, image::PNG));
